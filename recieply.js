    ...
    render() {
        return (
            <div className="tile" onClick={this.handleClick.bind(this)}>
                <TileMain title={this.props.data.title} img={this.props.data.img} />
                <TileFooter />
            </div>
        );
    }
    ...
    render() {
        const data = this.props.data,
            tileNodes = data.map((data) => {
                return <Tile show={this.props.show} data={data} />;
            });
        return (
            <div className="container">
                <main className="tile-container">{tileNodes}</main>
            </div>
        );
    }
}
...
class TileHeader extends React.Component {
    render() {
        return <header className="tile__header">{this.props.title}</header>;
    }
}
        ...
        return (
            <footer className="tile__footer">
                <button className="btn-primary">
                    <i className="zmdi zmdi-open-in-new zmdi-hc-lg btn-icon" /> open
                    recipe
                </button>
            </footer>
        );
            ...
            <div className="form-bg-overlay" onClick={this.handleClick.bind(this)}>
                <div className="form-bg">
                    <form className="form" onSubmit={this.handleSubmit.bind(this)}>
                        ...
                        <textarea onChange={this.handleInstructionsChange.bind(this)} />
                        ...
                        />
                        <input type="submit" value="add recipe" className="btn-primary" />
                        {error}
                    </form>
                </div>
            </div>
